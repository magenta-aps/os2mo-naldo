...
{:then facets}
  ...
  {#if addressType}
    ...
    {:else if addressType.name == "Webadresse"}
      <Input title="Weabdresse" id="webadress" bind:value={input} required={true} />
    ...
    {:else if addressType.name == "Returadresse"}
      <Input title="Returadresse" id="returnadress" bind:value={input} required={true} />
    ...
    {:else if addressType.name == "Telefon"}
      <Input title="Telefon" id="phone" bind:value={input} required={true} />
    {/if}
  {/if}
