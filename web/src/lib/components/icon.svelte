<script lang="ts">
  enum Icon {
    ...
    GRID = "grid",
    PLUS = "plus",
    ARROW = "arrow", // Pointing to the right, used for toggling
    DRAGHANDLE = "draghandle", // used for resize
  }
...
{:else if type == Icon.CLIPBOARD}
  <svg {fill} width={size} height={size} xmlns="http://www.w3.org/2000/svg"
    ><path
...
{:else if type == Icon.DRAGHANDLE}
  <!-- made with https://www.svgrepo.com/ -->
  <svg
    xmlns="http://www.w3.org/2000/svg"
    {fill}
    width={size}
