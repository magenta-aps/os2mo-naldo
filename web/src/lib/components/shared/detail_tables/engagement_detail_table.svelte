<script lang="ts">
  ...
  const headers = isOrg ? ["Navn", "Stillingbetegnelse", "Engagementstype", "Primær", "Dato"] : ["Enhed", "Stillingbetegnelse", "Engagementstype", "Primær", "Dato"]
  ...
  {:then data}
    ...
    {@const engagement = eng.objects[0]}
      <tr class="py-4 leading-5 border-t border-slate-300 text-secondary">
        ...
        <td class="p-4">{engagement.is_primary ? "Primær" : "Ikke primær"}</td>
