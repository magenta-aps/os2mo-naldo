...
export type EmployeeQuery = { __typename?: 'Query', employees: Array<{ __typename?: 'EmployeeResponse', objects: Array<{ __typename?: 'Employee', given_name: string, surname: string, nickname_givenname?: string | null, nickname_surname?: string | null, cpr_no?: any | null, seniority?: any | null, validity: { __typename?: 'OpenValidity', from?: any | null, to?: any | null } }> }> };
