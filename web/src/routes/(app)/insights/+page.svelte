<script lang="ts">
  ...
  // Assuming you updated this file with the safe browser download logic
  ...
  // The new mainQueries with 'query', 'getHeaders', 'getValues'
  ...
  const updateQuery = async () => {
    ...
    const queryFields = selectedQueries
      .map((q) => {
        ...
        // Case 3: Standard Children (Engagements, Associations, etc)
        return {
