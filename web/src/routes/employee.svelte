<script lang="ts">
	// const employees = ['Henrik', 'Anne', 'Jens', 'Bodil', 'Jan ', 'Cecilie', 'Sandra', 'Emilie']
...
<div class="h-screen m-auto p-10">
	<div class="card bg-base-200 shadow-xl">
		<div class="card-body grid grid-cols-2">
			...
			<input type="text" placeholder="Søg" class="input input-bordered" bind:value={input} />
			<div>
				<label>
					<input type="radio" name="radio-1" class="radio" value={true} bind:group={cardView} />
				</label>
				<label>
					<input type="radio" name="radio-1" class="radio" value={false} bind:group={cardView} />
				</label>
			</div>
		</div>
	</div>
