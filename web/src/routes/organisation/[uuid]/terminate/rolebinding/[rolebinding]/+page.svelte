              ...
              message: capital(
                $_("success_terminate", {
                  values: {
                    ...
                    name: mutation.rolebinding_terminate.objects[0]?.org_unit?.[0].name,
                  },
                })
              ),
...
{#await graphQLClient().request( RolebindingDocument, { uuid: $page.params.rolebinding, fromDate: $date } )}
  <div class="mx-6">
