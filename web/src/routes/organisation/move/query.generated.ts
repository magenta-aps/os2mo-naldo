...
export type OrgUnitQuery = { org_units: { objects: Array<{ objects: Array<{ name: string, uuid: any }> }> } };
...
export type UpdateOrgUnitMutation = { org_unit_update: { uuid: any, objects: Array<{ name: string, parent?: { name: string } | null }> } };
