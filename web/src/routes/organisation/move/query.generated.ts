...
export type UpdateOrgUnitMutation = { __typename?: 'Mutation', org_unit_update: { __typename?: 'OrganisationUnitResponse', uuid: any, objects: Array<{ __typename?: 'OrganisationUnit', name: string, parent?: { __typename?: 'OrganisationUnit', name: string } | null }> } };
