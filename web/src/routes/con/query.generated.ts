...
export type OrgUnitsWithChildrenQuery = { org_units: { objects: Array<{ validities: Array<{ name: string, uuid: any, children: Array<{ uuid: any }> }> }> } };
...
export type OrgUnitChildrenQuery = { org_units: { objects: Array<{ validities: Array<{ name: string, uuid: any, children: Array<{ uuid: any }> }> }> } };
